import ts1 from './Group 34571.png';
import ts2 from './Isolated_back_white_hoodie 1.png';
import ts3 from './Isolated_black_t-shirt_front 2.png';
import ArrowHead from './Arrowhead Blue.png';
const Merchandise = () => {
    return (
        <div className="merch">
